...
class CommandHandler:
    """
    Simple command handler imilar to cmd.Cmd from the standard
    library.
    """
    def unknown(self, session, cmd):
	'Respond to an unknow command'
...
class Room(CommandHandler):
    ...
    (sessions). It takes care of basic command handing and
    broadcasting.
    """
...
class ChatRoom(Room):
    """
    A room meant for multiple users who can caht with the others in 
    the room.
    """
...
class ChatSession(async_chat):
    """
    A single session, shich takes care of the communication with a 
    single user.
    """
